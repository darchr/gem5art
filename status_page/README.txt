...
This webpage displays the results of gem5 tests. To view the tests:
  ...
  2) Either move the JSON file to the status directory (recommended) OR change the JSONpath variable in the statusPage.html document to the path to the JSON file.
